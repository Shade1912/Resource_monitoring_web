...
# 	put_watermark(
# 		input_pdf='watermark.pdf', # the original pdf
# 		output_pdf='final_report.pdf', # the modified pdf with watermark
# 		watermark='reportres.pdf' # the watermark to be provided
# 	)
